package com.flowboard.subscription_service.aop;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.flowboard.subscription_service.service.*.*(..))")
    ...
    @Around("execution(* com.flowboard.subscription_service.controller.*.*(..))")
