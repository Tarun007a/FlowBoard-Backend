package com.flowboard.notification_service.aop;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.flowboard.notification_service.service.*.*(..))")
    ...
    @Around("execution(* com.flowboard.notification_service.controller.*.*(..))")
