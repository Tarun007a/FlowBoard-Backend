package com.flowboard.workspace_service.aop;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.flowboard.workspace_service.service.*.*(..))")
    ...
    @Around("execution(* com.flowboard.workspace_service.controller.*.*(..))")
