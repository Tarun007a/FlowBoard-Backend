package com.flowboard.comment_service.aop;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.flowboard.comment_service.service.*.*(..))")
    ...
    @Around("execution(* com.flowboard.comment_service.controller.*.*(..))")
